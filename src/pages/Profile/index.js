...
import { db, storage } from '../../services/firebaseConnection.js';
import { ref, uploadBytes, getDownloadURL } from 'firebase/storage';
import './profile.css';

export default function Profile() {

    const { user, storageUser, setUser, logout } = useContext(AuthContex);
    ...
    function handleFile(e) {
        if (e.target.files[0]) {
            ...
            if (image.type === 'image/jpg' || image.type === 'image/png') {
                ...
                toast.error("Foto não suportada, use apenas jpg ou png");
                setImageAvatar(null);
                return;
            }
        }
